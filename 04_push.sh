...
# Push Script for Kanizsa Agent Adjective
...
print_status "Kanizsa Agent Adjective - Push Script"
print_status "====================================="
...
LOCAL_COMMITS=$(git log --oneline origin/main..HEAD 2>/dev/null || git log --oneline origin/master..HEAD 2>/dev/null || echo "")
