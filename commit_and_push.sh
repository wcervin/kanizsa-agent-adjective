...
# Commit and Push Script for Kanizsa Adjective Agent
# This script handles version bumping, committing, and pushing for the Adjective Agent
...
print_status "Kanizsa Adjective Agent - Commit and Push Script"
print_status "================================================="
...
print_status "Repository: kanizsa-agent-adjective"
...
print_success "Adjective Agent commit and push complete!"
